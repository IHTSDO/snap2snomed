...
create table if not exists imported_code (id bigint generated by default as identity, code varchar(50), display varchar(2048), _index bigint not null, imported_codeset_id bigint not null, primary key (id));
