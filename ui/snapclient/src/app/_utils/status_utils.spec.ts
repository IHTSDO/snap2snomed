...
describe('StatusUtils', () => {
  ...
  const draftSource_noMap = new MapView('', undefined, '1', 'abc',
    ...
    true, null, null, null, null, null, undefined, false, undefined, []);
