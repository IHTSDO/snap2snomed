  ...
  api_ecs_environment = [
    {
      ...
      value = "jdbc:mariadb:aurora//${aws_rds_cluster_instance.api.endpoint}:${aws_rds_cluster_instance.api.port}/${aws_rds_cluster.api.database_name}?useServerPrepStmts=false"
    },
    {
